                    ...
                    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                            ...
                            <div class="flex justify-between items-center mt-6">
                                <form action="{{ route('payments.earnings') }}" method="GET" class="flex space-x-4">

                                    <div>
                                        <label for="year" class="block text-sm font-medium text-gray-700">Tahun</label>
                                        <input type="number" name="year" id="year" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" 
                                            value="{{ request('year') }}" placeholder="Contoh: 2024">
                                    </div>
                                    <button type="submit" class="px-6 py-2 bg-gray-800 text-white rounded-md mt-6">Tampilkan</button>
                                </form>
                            </div>
